...
<title>Диплом &mdash; Заказать диплом</title>
...
<link
	href="https://fonts.googleapis.com/css?family=Crimson+Text:500,500i,600|Montserrat:200,300,500"
	rel="stylesheet">
...
<body data-spy="scroll" data-target="#pb-navbar" data-offset="200">
	...
	<section
		class="pb_cover_v4 overflow-hidden cover-bg-indigo cover-bg-opacity text-left pb_gradient_v1 pb_slant-light"
		id="section-home">
		<div class="container">
			<!-- <br> <br> <br>-->
			<div class="row align-items-center justify-content-center">
				<div class="col-md-6">
					<h2 class="heading mb-3" style="font-size: 3em;">Заказать дипломную
						работу</h2>
					<div class="sub-heading">
						<p class="mb-4">
							Выполнение дипломных работ по программированию, информатике,
							автоматизированным системам и базам данных.
						...
						<p class="mb-5">
							<a class="btn btn-success btn-lg pb_btn-pill smoothscroll"
								...
								class="pb_font-14 text-uppercase pb_letter-spacing-1">Посмотреть
									цены</span></a>
						</p>
					</div>
				</div>
	...
	<section class="pb_section bg-light pb_slant-white pb_pb-220"
		id="section-features">
		<div class="container">
				...
				<div class="col-lg-4 col-md- col-sm-6">
					<div class="media d-block pb_feature-v1 text-left">
						...
						<div class="media-body">
							...
							<p class="text-sans-serif">Приложения разрабатываются с
								применение современных средств разработки.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md- col-sm-6">
					<div class="media d-block pb_feature-v1 text-left">
						...
						<div class="media-body">
							...
							<p class="text-sans-serif">Работы выполняются в приватных
								репозиториях на гитхабе, поэтому вы можете каждый день
								контролировать ход выполнения работы.</p>
						</div>
					</div>
				</div>
						...
						<div class="col">
							...
							<p class="pb_font-20">
								Примеры выполнения типовых проектов вы можете посмотреть на <a
									...
									target="_blank">гитхабе</a>. Эти приложения являются
								демонстрационным примером выполнения типовых заданий, работы
								клиентов мы никогда не показываем.
							</p>
						</div>
					</div>
					<div class="row">
						<div class="col-lg">
							...
							<div class="media pb_feature-v2 text-left mb-1 mt-5">
								...
								<div class="media-body">
									...
									<p class="text-sans-serif pb_font-16">Информационная система
										складского учета в магазин компьютерной техники. Стек: PHP,
										YII, MariaDB.</p>
								</div>
							</div>
							...
							<div class="media pb_feature-v2 text-left mb-1 mt-5">
								...
								<div class="media-body">
									...
									<p class="text-sans-serif pb_font-16">Поиск простых чисел
										Вольстенхольма, Вифериха и поиск суперпростых чисел на
										бесконечном множестве чисел. Для решения данных задач была
										использована библиотека GMP.</p>
								</div>
							</div>
						...
						<div class="col-lg">
							...
							<div class="media pb_feature-v2 text-left mb-1 mt-5">
								...
								<div class="media-body">
									<h3 class="mt-2 mb-2 heading">C#</h3>
									<p class="text-sans-serif pb_font-16">Система учета аренды
										объектов недвижимости. Стек: C#, Windows Forms, MySQL.</p>
								</div>
							</div>
							...
							<div class="media pb_feature-v2 text-left mb-1 mt-5">
								...
								<div class="media-body">
									<h3 class="mt-2 mb-2 heading">PHP</h3>
									<p class="text-sans-serif pb_font-16">Интернет магазин
										электроники на OpenCart.</p>
								</div>
							</div>
			...
			<div class="row">
				<div class="col-md">
					<div class="pb_pricing_v1 p-5 border text-center bg-white">
						...
						<p class="pb_font-15">Бакалаврские работы от 16 000. Точную цену
							уточняйте.</p>
						<p class="mb-0">
							<a href="#section-home" role="button" class="btn btn-primary btn-shadow-blue">Заказать</a>
						</p>
					</div>
				</div>
				<div class="col-md">
					<div
						class="pb_pricing_v1 p-5 border border-primary text-center bg-white">
						<h3>Магистерская диссертация</h3>
						<span class="price"><sup>Р</sup>20 000</span>
						<p class="pb_font-15">Магистерские диссертации от 20 000. Точную
							цену уточняйте.</p>
						<p class="mb-0">
							<a href="#section-home" role="button" class="btn btn-primary btn-shadow-blue">Заказать</a>
						</p>
					...
					<div id="pb_faq" class="pb_accordion" data-children=".item">
						<div class="item">
							<a data-toggle="collapse" data-parent="#pb_faq" href="#pb_faq1"
								aria-expanded="false" aria-controls="pb_faq1"
								class="pb_font-22 py-4">Сколько времени вам поднадобится на
								выполнение работы?</a>
							<div id="pb_faq1" class="collapse " role="tabpanel">
								<div class="py-3">
									<p>Сроки написания каждой работы обговариваются индивидуально.</p>
									<p>Обычно на написание бакалаврской работы требуется от двух до
										трех недель, магистерской &mdash; от двух до четырех недель.</p>
								</div>
							</div>
						</div>
						<div class="item">
							<a data-toggle="collapse" data-parent="#pb_faq" href="#pb_faq2"
								aria-expanded="false" aria-controls="pb_faq2"
								class="pb_font-22 py-4">Какие технологии вы используете?</a>
							<div id="pb_faq2" class="collapse" role="tabpanel">
								<div class="py-3">
									<p>Мы делаем десктопные приложения на C# (Windows Forms, WPF,
										UWP) и веб-сайты на PHP. Базы данных: PostgreSQL, MySQL,
										MariaDB, Redis, MS SQL Server. Но можем обсудить и другие
										технологии. В случае разработки веб-сайта мы можем бесплатно
										разместить ваш сайт на своем хостинге, подключить домен и
										почтовый сервер.</p>
								</div>
							</div>
						</div>
						<div class="item">
							<a data-toggle="collapse" data-parent="#pb_faq" href="#pb_faq3"
								aria-expanded="false" aria-controls="pb_faq3"
								class="pb_font-22 py-4">Смогу ли я заказать доработку в случае
								необходимости?</a>
							<div id="pb_faq3" class="collapse" role="tabpanel">
								<div class="py-3">
									<p>Да. Все доработки в рамках задания и мелкие поправки
										проводятся бесплатно. При необходимости внесения существенных
										изменений не обговоренных заранее, цена за работу будет
										пересмотренна.</p>
								</div>
							</div>
						</div>
						<div class="item">
							<a data-toggle="collapse" data-parent="#pb_faq" href="#pb_faq4"
								aria-expanded="false" aria-controls="pb_faq4"
								class="pb_font-22 py-4">Я получу уникальную работу?</a>
							<div id="pb_faq4" class="collapse" role="tabpanel">
								<div class="py-3">
									<p>Все наши работы являются оригинальными и пишутся только для
										одного клиента. Перепродажами работ мы не занимаемся.
										Уникальность работы составляет не менее 70%, проверяется по
										системам антиплагиата antiplagiat.ru и etxt.ru. При
										необходимости мы можем проверить и по другим системам.</p>
								</div>
							</div>
						</div>
						...
						<div class="item">
							<a data-toggle="collapse" data-parent="#pb_faq" href="#pb_faq5"
								aria-expanded="false" aria-controls="pb_faq5"
								class="pb_font-22 py-4">Какие у меня гарантии?</a>
							<div id="pb_faq5" class="collapse" role="tabpanel">
								<div class="py-3">
									<p>Оплата может производиться по частям. Работы выполняются в
										приватных репозиториях на гитхабе, поэтому вы можете каждый
										день видеть прогесс написания вашей работы.</p>
								</div>
							</div>
						</div>
